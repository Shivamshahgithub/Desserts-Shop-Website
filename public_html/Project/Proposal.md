...
- Milestone 2
  - [X] \(4/25/2022) User with an admin role or shop owner role will be able to add products to inventory
    - Table should be called Products (id, name, description, category, stock, created, modified, unit_price, visibility [true, false])
  - [Milestone2](https://github.com/Shivamshahgithub/IT202-004/blob/Milestone2/public_html/Project/milestone2.md)
  - [Add Items](https://ss4349-prod.herokuapp.com/Project/admin/add_item.php)

  - [X] \(4/25/2022) Any user will be able to see products with visibility = true on the Shop page
  ...
  - [X] \(4/25/2022) Admin/Shop owner will be able to see products with any visibility
  ...
  - [Milestone2](https://github.com/Shivamshahgithub/IT202-004/blob/Milestone2/public_html/Project/milestone2.md)
  - [List Items](https://ss4349-prod.herokuapp.com/Project/admin/list_items.php)

  - [X] \(4/25/2022) Admin/Shop owner will be able to edit any product
  ...
  - [Milestone2](https://github.com/Shivamshahgithub/IT202-004/blob/Milestone2/public_html/Project/milestone2.md)
  - [Edit Product](https://ss4349-prod.herokuapp.com/Project/admin/edit_item.php)
  - [Shop](https://ss4349-prod.herokuapp.com/Project/shop.php)
  - [List Items](https://ss4349-prod.herokuapp.com/Project/admin/list_items.php)

  - [X] \(4/25/2022) User will be able to click an item from a list and view a full page with more info about the item (Product Details Page)
    - Name, description, unit_price, stock, category
  - [Milestone2](https://github.com/Shivamshahgithub/IT202-004/blob/Milestone2/public_html/Project/milestone2.md)
  - [Product Details](https://ss4349-prod.herokuapp.com/Project/product_details.php?id=2)

  - [X] \(4/25/2022) User must be logged in for any Cart related activity below
  - [Milestone2](https://github.com/Shivamshahgithub/IT202-004/blob/Milestone2/public_html/Project/milestone2.md)
  - [Cart](https://ss4349-prod.herokuapp.com/Project/cart.php)

  - [X] \(4/25/2022) User will be able to add items to Cart
  ...
  - [X] \(4/25/2022) User will be able to see their cart
    - List all the items
  ...
  - [X] \(4/25/2022) User will be able to change quantity of items in their cart
    - Quantity of 0 should also remove from cart
    - A negative Quantity is not valid
  - [Milestone2](https://github.com/Shivamshahgithub/IT202-004/blob/Milestone2/public_html/Project/milestone2.md)
  - [Cart](https://ss4349-prod.herokuapp.com/Project/cart.php)

  - [X] \(4/25/2022) User will be able to remove a single item from their cart via button click
  - [Milestone2](https://github.com/Shivamshahgithub/IT202-004/blob/Milestone2/public_html/Project/milestone2.md)
  - [Cart](https://ss4349-prod.herokuapp.com/Project/cart.php)

  - [X] \(4/25/2022) User will be able to clear their entire cart via a button click
  - [Milestone2](https://github.com/Shivamshahgithub/IT202-004/blob/Milestone2/public_html/Project/milestone2.md)
  - [Cart](https://ss4349-prod.herokuapp.com/Project/cart.php)

- Milestone 3
  - [X] \(5/12/2022) User will be able to purchase items in their Cart
    - Create an Orders table (id, user_id, created, total_price, address, payment_method, money_received)
      ...
      - This must be inserted first before you can insert into the OrderItems table.
  ...
  - [Milestone3](https://github.com/Shivamshahgithub/IT202-004/blob/Milestone3/public_html/Project/milestone3.md)
  - [Checkout](https://ss4349-prod.herokuapp.com/Project/cart.php)

  - [X] \(5/12/2022) Order Confirmation Page
  ...
  - [Milestone3](https://github.com/Shivamshahgithub/IT202-004/blob/Milestone3/public_html/Project/milestone3.md)
  - [Order Confirm](https://ss4349-prod.herokuapp.com/Project/order_confirm.php)

  - [X] \(5/12/2022) User will be able to see their Purchase History
  ...
  - [Order Details](https://ss4349-prod.herokuapp.com/Project/order_details.php)

  - [X] \(5/12/2022) Store Owner will be able to see all Purchase History
    - For now limit to 10 most recent orders
    - A list item can be clicked to view the full details in the Order Details Page (similar to Order Confirmation Page except no “Thank you” message)
  - [Milestone3](https://github.com/Shivamshahgithub/IT202-004/blob/Milestone3/public_html/Project/milestone3.md)
  - [Purchase History](https://ss4349-prod.herokuapp.com/Project/purchase_history.php)
