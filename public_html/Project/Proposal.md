...
- Milestone 2
  - Milestone 2
  - [X] \(//2022) User with an admin role or shop owner role will be able to add products to inventory
    - Table should be called Products (id, name, description, category, stock, created, modified, unit_price, visibility [true, false])

  - [X] \(//2022) Any user will be able to see products with visibility = true on the Shop page
  ...
  - [X] \(//2022) Admin/Shop owner will be able to see products with any visibility
  ...
  - [X] \(//2022) Admin/Shop owner will be able to edit any product
  ...
  - [X] \(//2022) User will be able to click an item from a list and view a full page with more info about the item (Product Details Page)
    - Name, description, unit_price, stock, category

  - [X] \(//2022) User must be logged in for any Cart related activity below

  - [X] \(//2022) User will be able to add items to Cart
  ...
  - [X] \(//2022) User will be able to see their cart
    - List all the items
  ...
  - [X] \(//2022) User will be able to change quantity of items in their cart
    - Quantity of 0 should also remove from cart
    - A negative Quantity is not valid

  - [X] \(//2022) User will be able to remove a single item from their cart via button click

  - [X] \(//2022) User will be able to clear their entire cart via a button click
